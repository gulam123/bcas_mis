                                    ...
                                    <div class="d-flex flex-column mb-7 fv-row">
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <div class="position-absolute translate-middle-y top-50 end-0 me-5">
                                                <img src="<?php echo base_url('Metro/dist/assets/media/svg/card-logos/visa.svg'); ?>" alt="" class="h-25px" />
                                                <img src="<?php echo base_url('Metro/dist/assets/media/svg/card-logos/mastercard.svg'); ?>" alt="" class="h-25px" />
                                                <img src="<?php echo base_url('Metro/dist/assets/media/svg/card-logos/american-express.svg'); ?>" alt="" class="h-25px" />
                                            </div>
                                            <!--end::Card logos-->
                                        </div>
                                        <!--end::Input wrapper-->
                            ...
                            <div data-kt-stepper-element="content">
                                <div class="w-100 text-center">
                                    ...
                                    <div class="text-center px-4 py-15">
                                        <img src="<?php echo base_url('Metro/dist/assets/media/illustrations/sketchy-1/9.png'); ?>" alt="" class="mw-100 mh-300px" />
                                    </div>
                                    <!--end::Illustration-->
                                </div>
                            </div>
                    ...
                    <div class="py-5">
                            ...
                            <div class="mh-375px scroll-y me-n7 pe-7">
                                ...
                                <a href="#" class="d-flex align-items-center p-3 rounded bg-state-light bg-state-opacity-50 mb-1">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle me-5">
                                        <img alt="Pic" src="<?php echo base_url('Metro/dist/assets/media/avatars/300-6.jpg'); ?>" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Info-->
                                    <div class="fw-bold">
                                ...
                                <a href="#" class="d-flex align-items-center p-3 rounded bg-state-light bg-state-opacity-50 mb-1">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-35px symbol-circle me-5">
                                        <img alt="Pic" src="<?php echo base_url('Metro/dist/assets/media/avatars/300-1.jpg'); ?>" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Info-->
                                    <div class="fw-bold">
                                ...
                                <a href="#" class="d-flex align-items-center p-3 rounded bg-state-light bg-state-opacity-50 mb-1">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-35px symbol-circle me-5">
                                        <img alt="Pic" src="<?php echo base_url('Metro/dist/assets/media/avatars/300-5.jpg'); ?>" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Info-->
                                    <div class="fw-bold">
                                ...
                                <a href="#" class="d-flex align-items-center p-3 rounded bg-state-light bg-state-opacity-50 mb-1">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-35px symbol-circle me-5">
                                        <img alt="Pic" src="<?php echo base_url('Metro/dist/assets/media/avatars/300-25.jpg'); ?>" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Info-->
                                    <div class="fw-bold">
                            ...
                            <div class="mh-375px scroll-y me-n7 pe-7">
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="6">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Avatar-->
                                        <div class="symbol symbol-35px symbol-circle">
                                            <img alt="Pic" src="<?php echo base_url('Metro/dist/assets/media/avatars/300-9.jpg'); ?>" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Details-->
                                        <div class="ms-5">
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="9">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Avatar-->
                                        <div class="symbol symbol-35px symbol-circle">
                                            <img alt="Pic" src="<?php echo base_url('Metro/dist/assets/media/avatars/300-23.jpg'); ?>" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Details-->
                                        <div class="ms-5">
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="11">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Avatar-->
                                        <div class="symbol symbol-35px symbol-circle">
                                            <img alt="Pic" src="<?php echo base_url('Metro/dist/assets/media/avatars/300-12.jpg'); ?>" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Details-->
                                        <div class="ms-5">
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="13">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Avatar-->
                                        <div class="symbol symbol-35px symbol-circle">
                                            <img alt="Pic" src="<?php echo base_url('Metro/dist/assets/media/avatars/300-13.jpg'); ?>" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Details-->
                                        <div class="ms-5">
                                ...
                                <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="15">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Avatar-->
                                        <div class="symbol symbol-35px symbol-circle">
                                            <img alt="Pic" src="<?php echo base_url('Metro/dist/assets/media/avatars/300-21.jpg'); ?>" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Details-->
                                        <div class="ms-5">
                        ...
                        <div data-kt-search-element="empty" class="text-center d-none">
                            ...
                            <div class="text-center px-5">
                                <img src="<?php echo base_url('Metro/dist/assets/media/illustrations/sketchy-1/1.png'); ?>" alt="" class="w-100 h-200px h-sm-325px" />
                            </div>
                            <!--end::Illustration-->
                        </div>
                        <!--end::Empty-->
    ...
    <div class="modal-dialog mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                ...
                <img alt="Logo" src="<?php echo base_url('Metro/dist/assets/media/svg/brand-logos/google-icon.svg'); ?>" class="h-20px me-3" />Invite Gmail Contacts</div>
...
<!-- modal logout-->
<div class="modal fade" id="elogout" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog mw-650px">
        <!--begin::Modal content-->
        <div class="modal-content">
            <!--begin::Modal header-->
...
<div class="modal fade" id="detailAnomali" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog mw-950px">
        <div class="modal-content">
            <div class="modal-header pb-0 border-0">
                <h4 class="modal-title" id="exampleModalLabel">Detail Data Nasabah</h4>
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15 mt-5">
                <div class="row">
                    <div class="col-lg-12">
                        <!-- <p id="ANOMALI"></p> -->
                        <div class="row mb-4">
                            <div class="col-lg-3">
                                <p class="text-primary">USER INPUT</p>
                            </div>
                            <div class="col-lg-3">
                                <h5 class="text-danger" id="USER_INPUT">-</h5>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-lg-3">
                                <p class="text-primary">CABANG INDUK</p>
                            </div>
                            <div class="col-lg-3">
                                <P id="CABANG_INDUK">-</P>
                            </div>
                            <div class="col-lg-3">
                                <p class="text-primary">NAMA CABANG</p>
                            </div>
                            <div class="col-lg-3">
                                <P id="NAMA_CABANG">-</P>
                            </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-3">
                                <p class="text-primary">NOMOR CIF</p>
                            </div>
                            <div class="col-lg-3">
                                <b id="NOMOR_CIF">-</b>
                            </div>
                            <div class="col-lg-3">
                                <p class="text-primary">TGL BUKA</p>
                            </div>
                            <div class="col-lg-3">
                                <b id="TGL_BUKA">-</b>
                            </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-3">
                                <p class="text-primary">NAMA SESUAI ID</p>
                            </div>
                            <div class="col-lg-3">
                                <p id="NAMA_SESUAI_ID">-</p>
                            </div>
                            <div class="col-lg-3">
                                <p class="text-primary">NAMA TANPA SINGKATAN</p>
                            </div>
                            <div class="col-lg-3">
                                <p id="NAMA_TANPA_SINGKATAN">-</p>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-lg-3">
                                <p class="text-primary">USER OTOR</p>
                            </div>
                            <div class="col-lg-3">
                                <p id="USER_OTOR">-</p>
                            </div>
                            <div class="col-lg-3">
                                <p class="text-primary">TGL OTOR</p>
                            </div>
                            <div class="col-lg-3">
                                <p id="TGL_OTOR">-</p>
                            </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-3">
                                <p class="text-primary">TGL UBAH</p>
                            </div>
                            <div class="col-lg-3">
                                <p id="TGL_UBAH">-</p>
                            </div>
                            <div class="col-lg-3">
                                <p class="text-primary">JAM UBAH</p>
                            </div>
                            <div class="col-lg-3">
                                <p id="JAM_UBAH">-</p>
                            </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-3">
                                <p class="text-primary">JENIS NASABAH</p>
                            </div>
                            <div class="col-lg-3">
                                <p id="JENIS_NASABAH">-</p>
                            </div>
                            <div class="col-lg-3">
                        ...
                        <!-- </?php var_dump([$Anomaliibu,$Anomalinik,$Anomalinpwp,$Anomaliumum]) ?> -->
                        <?php if($Anomaliibu=='NIK'): ?>
                            <div class="row mb-2">
                                <div class="col-lg-3">
                                    <p class="text-primary">NAMA IBU KANDUNG</p>
                                </div>
                                <div class="col-lg-3">
                                    <b id="NAMA_IBU_KANDUNG">-</b>
                                </div>
                            </div>
                        <?php elseif($Anomalinik=='IBU'): ?>
                        <div class="row mb-2">
                            <div class="col-lg-3">
                                <p class="text-primary">JENIS ID</p>
                            </div>
                            <div class="col-lg-3">
                                <b id="JENIS_IDENTITAS">-</b>
                            </div>
                            <div class="col-lg-3">
                                <p class="text-primary">NOMOR ID</p>
                            </div>
                            <div class="col-lg-3">
                                <b id="NOMOR_IDENTITAS">-</b>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-lg-3">
                                <p class="text-primary">JUMLAH DIGIT ID</p>
                            </div>
                            <div class="col-lg-3">
                                <b id="DIGIT_ID">-</b>
                            </div>
                        </div>
                        <?php elseif($Anomalinpwp=='NPWP'): ?>
                            <div class="row mb-2">
                                <div class="col-lg-3">
                                    <p class="text-primary">NOMOR NPWP</p>
                                </div>
                                <div class="col-lg-3">
                                    <b id="NOMOR_NPWP">-</b>
                                </div>
                                <div class="col-lg-3">
                                    <p class="text-primary">JUMLAH DIGIT NPWP</p>
                                </div>
                                <div class="col-lg-3">
                                    <b id="DIGIT_NPWP">-</b>
                                </div>
                            </div>
                        <?php elseif($Anomaliumum=='UMUM'): ?>
                            <div class="row mb-2">
                                <div class="col-lg-3">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-3">
                                    <b id="JENIS_KELAMIN">-</b>
                                </div>
                                <div class="col-lg-3">
                                    <p class="text-primary">AGAMA</p>
                                </div>
                                <div class="col-lg-3">
                                    <b id="AGAMA">-</b>
                                </div>
                            ...
                            <div class="row mb-2">
                                <div class="col-lg-3">
                                    <p class="text-primary">STATUS KAWIN</p>
                                </div>
                                <div class="col-lg-3">
                                    <b id="STATUS_PERKAWINAN">-</b>
                                </div>
                                <div class="col-lg-3">
                                    <p class="text-primary">NEGARA ASAL</p>
                                </div>
                                <div class="col-lg-3">
                                    <b id="NEGARA_ASAL">-</b>
                                </div>
                            ...
                            <div class="row mb-2">
                                <div class="col-lg-3">
                                    <p class="text-primary">TANGGAL ID</p>
                                </div>
                                <div class="col-lg-3">
                                    <b id="TANGGAL_IDENTITAS">-</b>
                                </div>
                                <div class="col-lg-3">
                                    <p class="text-primary">TANGGAL JT ID</p>
                                </div>
                                <div class="col-lg-3">
                                    <b id="TANGGAL_JT_IDENTITAS">-</b>
                                </div>
                            </div>
                        <?php endif ?>
                    </div>
