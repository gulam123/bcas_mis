        ...
        <div class="card shadow mb-4"> -->
            <form action="<?php echo site_url('export'); ?>" method="POST">
                <div class="card-header py-3 mb-3">
                    <h3 class="font-weight-bold text-primary mb-4">CARI DATA ANOMALI IBU KANDUNG</h3>
                    <div class="col-lg-12">
                        <div class="row form-group col-sm-8">
                            <label for="cabang" class="col-sm-3 col-form-label">Cabang</label>
                            <div class="col-sm-6">
                                <select name="cabang" id="cabang_ibu" class="form-select form-select-solid" data-kt-select2="true">
                        ...
                        <div class="row form-group col-sm-8 mt-3">
                            ...
                            <div class="col-sm-3 mb-3">
                                <input type="date" name="tgl_input" id="tgl_input_ibu" class="form-control">
                            </div>
                            <div class="col-sm-3">
                                <input type="date" name="tgl_inputakhir" id="tgl_inputakhir_ibu" class="form-control">
                            </div>
                        </div>
                        <div class="row form-group col-sm-8 mt-3">
                            <label for="periode" class="col-sm-3 col-form-label">Periode Data</label>
                            <div class="col-sm-6 mb-3">
                                <input type="date" name="periode" id="periode_ibu" class="form-control">
                            </div>
                            <div class="col-sm-3">
                                <input class="btn btn-md btn-primary" type="button" id="cari" value="CARI">
                            </div>
                        </div>
                    </div>
            ...
            <div class="card-body mt-5">
                <div class="card-title">
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input type="text" name="search" id="search_ibu" data-kt-user-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Masukkan dan Enter" />
                    </div>
                </div>
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="dataTable">
                        <thead>
                            <tr class="text-start text-primary fw-bolder fs-5 text-uppercase gs-0">
                                ...
                                <th class="min-w-200px">NAMA IBU KANDUNG</th>
