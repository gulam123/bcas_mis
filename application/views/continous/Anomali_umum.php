<form action="<?php echo site_url('C_excel/Lap_anomali_umum'); ?>" method="POST">
    <div class="card-header py-3">
        <h3 class="font-weight-bold text-primary mb-4">CARI DATA ANOMALI DATA UMUM</h3>
        <div class="col-lg-12">
            <div class="row form-group col-sm-8">
                <label for="cabang" class="col-sm-3 col-form-label">Cabang</label>
                <div class="col-sm-6">
                    <select name="cabang" id="cabang_umum" class="form-select form-select-solid" data-kt-select2="true">
            ...
            <div class="row form-group col-sm-8 mt-3">
                ...
                <div class="col-sm-3 mb-3">
                    <input type="date" name="tgl_input" id="tgl_input_umum" class="form-control">
                </div>
                <div class="col-sm-3">
                    <input type="date" name="tgl_inputakhir" id="tgl_inputakhir_umum" class="form-control">
                </div>
            </div>
            <div class="row form-group col-sm-8">
                <label for="periode" class="col-sm-3 col-form-label">Periode Data</label>
                <div class="col-sm-6 mb-3">
                    <input type="date" name="periode" id="periode_umum" class="form-control">
                </div>
                <div class="col-sm-3">
                    <input class="btn btn-md btn-primary" type="button" id="cari_umum" value="CARI">
                </div>
            </div>
...
<div class="card-body mt-5">
    <div class="card-title">
        ...
        <div class="d-flex align-items-center position-relative my-1">
            ...
            <!--end::Svg Icon-->
            <input type="text" name="search" id="search_umum" class="form-control form-control-solid w-250px ps-14" placeholder="Tekan Enter" />
        </div>
        <!--end::Search-->
    </div>
    <div class="table-responsive">
        <table class="table table-striped align-middle table-row-dashed fs-6 gy-5" id="dataTableUmum">
            <thead>
                <tr class="text-start text-primary fw-bolder fs-5 text-uppercase gs-0">
                    ...
                    <!-- <th class="min-w-125px">IBU KANDUNG</th> -->
                    <th class="min-w-125px">JENIS KELAMIN</th>
                    <th class="min-w-125px">AGAMA</th>
                    <th class="min-w-125px">STATUS KAWIN</th>
                    <!-- <th class="min-w-125px">JENIS ID</th> -->
                    <th class="min-w-125px">NOMOR NPWP</th>
                    <th class="min-w-125px">NOMOR ID</th>
                    <th class="min-w-125px">TGL IDENTITAS</th>
                    <th class="min-w-125px">TGL JT ID</th>
                    <th class="min-w-125px">NEGARA ASAL</th>
