...
<div class="card-header py-3">
    <h3 class="font-weight-bold text-primary mb-4">CARI DATA ANOMALI NASABAH INDIVIDU (MANDATORY)</h3>
    <div class="col-lg-12">
        <div class="row form-group col-sm-8">
            <label for="cabang" class="col-sm-3 col-form-label">Cabang</label>
            <div class="col-sm-6">
                <select name="cabang" id="cabang_nsbh_individu" class="form-control">
        ...
        <div class="row form-group col-sm-8 mt-3">
            ...
            <div class="col-sm-3 mb-3">
                <input type="date" name="tgl_input" id="tgl_input_nsbh_individu" class="form-control">
            </div>
            <div class="col-sm-3">
                <input type="date" name="tgl_inputakhir" id="tgl_inputakhir_nsbh_individu" class="form-control">
            </div>
        </div>
        <div class="row form-group col-sm-8">
            <label for="periode" class="col-sm-3 col-form-label">Periode Data</label>
            <div class="col-sm-6">
                <input type="date" name="periode" id="periode_nsbh_individu" class="form-control">
            </div>
...
<div class="card-body mt-5">
    <div class="card-title">
        ...
        <div class="d-flex align-items-center position-relative my-1">
            ...
            <!--end::Svg Icon-->
            <input type="text" name="search" id="search_nsbh_individu" class="form-control form-control-solid w-250px ps-14" placeholder="Tekan Enter" />
        </div>
        <!--end::Search-->
    </div>
    <div class="table-responsive">
        <table class="table table-striped align-middle table-row-dashed fs-6 gy-5" id="dataTableNsbhIndividu">
            <thead>
